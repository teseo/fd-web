...
import {
  BottomContainer, BottomText,
  ButtonText, ContinueButtonContainer, GameContainer,
  GlobalHeader, HeaderContainer,
  HeaderText,
  PlayersCardContainer, RestartButtonContainer, TopLogoImage, TopLogoLink, TryAgainImage,
  WinnerImage
